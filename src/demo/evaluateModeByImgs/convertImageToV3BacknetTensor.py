...
def main(sess,inception_path,InputData_path,outTensor_path):
    '''
    :param sess:
        current session
    :param inception_path:
        the trained mode inception v3 path
    :param InputData_path:
        the images path
    :param outTensor_path:
        the convert tensor path
    :return:
        tensor
    '''

    with gfile.FastGFile(inception_path, 'rb') as f:
    ...
    for sub_dir in sub_dirs:
        ...
        parent_path = os.path.join(outTensor_path,dir_name)
        ...
        for file_image in file_list:
            ...
            bottleneck_path = os.path.join(outTensor_path,dir_name,img_name+img_suffix)+'.txt'
